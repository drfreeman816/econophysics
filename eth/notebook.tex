...
{\color{incolor}In [{\color{incolor}1}]:} \PY{c+c1}{\PYZsh{} Date parsing libs}
...
\[r_n \approx \ln{x_n} - \ln{n_{n-1}}\]
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}2}]:} \PY{c+c1}{\PYZsh{} Define return}
...
best one.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}3}]:} \PY{c+c1}{\PYZsh{} Apply Hanning window}
...
Here we both calculate the FFT (in red) and use the built-in function
provided by \emph{matplotlib} to obtain the value of the PSD in
\(dB/Hz\) (in blue) to compare the results. Both graphs are exactly the
same, even the amplitudes are the same, but they are moved to each other
by a constant value.

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}4}]:} \PY{c+c1}{\PYZsh{} FFT (with Hanning window)}
        ...
        \PY{n}{plt}\PY{o}{.}\PY{n}{psd}\PY{p}{(}\PY{n}{r}\PY{p}{,} \PY{n}{NFFT}\PY{o}{=}\PY{n}{np}\PY{o}{.}\PY{n}{size}\PY{p}{(}\PY{n}{r}\PY{p}{)}\PY{p}{,} \PY{n}{Fs}\PY{o}{=}\PY{l+m+mi}{2}\PY{o}{/}\PY{n}{data\PYZus{}size}\PY{p}{,} \PY{n}{linewidth}\PY{o}{=}\PY{l+m+mf}{0.5}\PY{p}{,} \PY{n}{color}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{b}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)} \PY{c+c1}{\PYZsh{} Default window is Hanning}
        \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
\end{Verbatim}
...
the efficient market hypothesis.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}5}]:} \PY{c+c1}{\PYZsh{} IFFT (Autocorrelation)}
...
correlated.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}6}]:} \PY{c+c1}{\PYZsh{} Volatility Clusters}
...
\[K_E(u) = \frac{3}{4}(1 - u^2)\] \[|u| \leq 1\]
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}7}]:} \PY{c+c1}{\PYZsh{} Plot Epanechnikov kernel}
        \PY{n}{plt}\PY{o}{.}\PY{n}{figure}\PY{p}{(}\PY{n}{figsize}\PY{o}{=}\PY{p}{(}\PY{l+m+mi}{10}\PY{p}{,}\PY{l+m+mi}{10}\PY{p}{)}\PY{p}{)}
...
The value found for \(\alpha\) is known as \emph{Hill Estimator}.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}8}]:} \PY{c+c1}{\PYZsh{} Plot (log\PYZhy{}log) of estimated return distribution}
        \PY{n}{plt}\PY{o}{.}\PY{n}{figure}\PY{p}{(}\PY{n}{figsize}\PY{o}{=}\PY{p}{(}\PY{l+m+mi}{10}\PY{p}{,}\PY{l+m+mi}{10}\PY{p}{)}\PY{p}{)}
...
and \(r_0 = 0.981\) (\(e=0.019\)).
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}9}]:} \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Analysis of the Absolute Value of Returns}\PY{l+s+se}{\PYZbs{}n}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
...
our distribution is the same as the estimation.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}10}]:} \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+se}{\PYZbs{}n}\PY{l+s+s1}{Linear Fit:}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
